...
bool render(ANativeWindow*w){
 ...
 text("ROBOT ADMIN AI OS",8*s,H-25*s,s,.92f,.96f,1); text("VERSION: 65.2",8*s,H-39*s,s,.6f,.75f,.95f);
...
extern "C" const char* ra652_version(){return"65.2";} extern "C" int ra652_core_ready(){return 1;} extern "C" int ra652_write(){return-403;} extern "C" int ra652_apply(){return-403;} extern "C" int ra652_restore(){return-403;} extern "C" int ra652_install(){return-403;} extern "C" int ra652_delete(){return-403;} extern "C" int ra652_repair(){return-403;} extern "C" int ra652_live_order(){return-403;}
